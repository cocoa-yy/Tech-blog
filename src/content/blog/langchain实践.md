...
.env 文件
```python
LANGSMITH_API_KEY="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"
LANGSMITH_PROJECT="default"
OPENROUTER_API_KEY="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"
```
...
## 概述（索引+检索生成）
![LangChain-RAG1](/Tech-blog/pic/langchain实践/LangChain-RAG1.png)  
1. 加载：通过文档加载器加载数据
...
![LangChain-RAG2](/Tech-blog/pic/langchain实践/LangChain-RAG2.png)  
